            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm sm:text-base text-gray-500 mt-0.5">Perbarui informasi kategori</p>
                    </div>
                </div>
                <nav class="flex items-center space-x-2 text-sm text-gray-500">
                    ...
                    <i class="fas fa-chevron-right text-gray-300 text-xs"></i>
                    <span class="text-green-600 font-semibold truncate max-w-[120px]">{{ $category->name }}</span>
                </nav>
            </div>
        </div>
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-4 border-b border-green-100">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Edit data kategori #{{ $category->id }}</p>
                    </div>
                </div>
            </div>
