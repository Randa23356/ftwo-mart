    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6 sm:p-8 mb-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">Buat layanan baru untuk ditampilkan di website</p>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('admin.services.store') }}" method="POST">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden mb-6">
                ...
                <div class="p-6 sm:p-8" x-data="iconPicker('{{ old('icon', 'shopping_cart') }}')">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 sm:p-8 space-y-5">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="{{ $inp }}" placeholder="Contoh: Pengiriman Express" required>
                    ...
                    <div>
                        ...
                        <input type="url" name="url" value="{{ old('url') }}" class="{{ $inp }}" placeholder="https://...">
                    ...
                    <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                        <input type="checkbox" name="is_active" id="is_active" value="1"
                               class="h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500" checked>
                        <div>
