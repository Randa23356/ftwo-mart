...
<div class="min-h-screen bg-gray-50 py-8 md:py-12">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-amber-100 rounded-2xl mb-4 shadow-sm">
            ...
            <p class="text-gray-500 text-sm">Bagikan pengalaman Anda dengan produk ini</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-5">
            <div class="p-5 flex items-center gap-4">
                ...
                <span class="px-3 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded-full flex-shrink-0">Baru</span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <h2 class="font-semibold text-gray-900 text-sm">Tulis Ulasan</h2>
            </div>

            <form action="{{ route('ratings.store', [$order, $product]) }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2" id="rating-stars">
                        @for ($i = 1; $i <= 5; $i++)
                            <button type="button"
                                    class="star-btn text-3xl md:text-4xl text-gray-300 hover:text-amber-400 transition-all duration-200 focus:outline-none p-0.5"
                                    data-rating="{{ $i }}"
                                    onclick="setRating({{ $i }})">
                                ★
                            </button>
                ...
                <div>
                    ...
                    <div class="flex justify-between items-center mt-1.5">
                        ...
                        @else
                            <span></span>
                        @enderror
                        <span class="text-xs text-gray-400"><span id="char-count">0</span>/1000</span>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-paper-plane mr-1.5"></i> Kirim Rating
                    </button>
                </div>
            </form>
        </div>
