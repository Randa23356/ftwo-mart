    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 sm:p-8">
                <form method="POST" action="{{ route('seller.products.store') }}" enctype="multipart/form-data" class="space-y-8" x-data="productForm()">
                    @csrf
                    ...
                    <div>
                        ...
                        <div x-show="images.length > 0" x-cloak class="mt-4">
                            <p class="text-sm font-semibold text-gray-700 mb-3">
                                ...
                                Preview Gambar (<span x-text="images.length"></span>)
                            </p>
