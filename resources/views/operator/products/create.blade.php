    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6 sm:p-8 mb-6 sm:mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <nav class="flex items-center space-x-2 text-sm text-gray-500">
                    <a href="{{ route('operator.dashboard') }}" class="hover:text-green-600 transition-colors font-medium">
                        <i class="fas fa-home mr-1"></i> Operator
                    </a>
                    <i class="fas fa-chevron-right text-gray-300 text-xs"></i>
                    <a href="{{ route('operator.products.index') }}" class="hover:text-green-600 transition-colors font-medium">Produk</a>
                    <i class="fas fa-chevron-right text-gray-300 text-xs"></i>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 sm:p-8">
                <form method="POST" action="{{ route('operator.products.store') }}" enctype="multipart/form-data" class="space-y-8" x-data="productForm()">
                    @csrf
