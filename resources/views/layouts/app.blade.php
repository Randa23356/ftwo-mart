...
<head>
    ...
    @if(isset($settings['logo']) && $settings['logo']->value)
        <link rel="shortcut icon" href="/{{ $settings['logo']->value }}" type="image/x-icon">
    @else
                    ...
                    <div class="flex items-center gap-8 lg:gap-12">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <a href="{{ route('home') }}" class="flex items-center group transition-transform hover:scale-105">
                                @if(isset($settings['logo']) && $settings['logo']->value)
                                    <img class="h-8 lg:h-12 w-auto mr-2 md:mr-3 drop-shadow-sm" src="/{{ $settings['logo']->value }}" alt="Logo">
                                @else
